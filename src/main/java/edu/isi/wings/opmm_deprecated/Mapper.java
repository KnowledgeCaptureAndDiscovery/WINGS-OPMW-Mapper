package edu.isi.wings.opmm_deprecated;
   ...
   //*************************//
    ...
    private void exportHardwareSoftwareDependencies(boolean needsval, Float memval, Float stval, Float minversionval, Resource concrComponent,int version_no){
        ...
        taxonomyExport.getResource(procURI).
                addProperty(taxonomyExport.createOntProperty(Constants.WINGS_PROP_HAS_HARDWARE_DEPENDENCY), 
                        blankNode112);
        ...
        taxonomyExport.getResource(procURI113).
                addProperty(taxonomyExport.createOntProperty(Constants.WINGS_PROP_HAS_SOFTWARE_DEPENDENCY), 
                        blankNode113);
