...
public class Constants {
    ...
    // public static final String PREFIX_GEO =
    ...
    // public static final String NEEDS_64BIT =
    ...
    // public static final String CONCEPT_WORKFLOW_EXPANDED_TEMPLATE_PROCESS =
    // "WorkflowExpandedTemplateProcess";
    // public static final String
    // CONCEPT_WORKFLOW_EXPANDED_TEMPLATE_PARAMETER_VARIABLE =
    // "WorkflowExpandedTemplateParameterVariable";
    // public static final String CONCEPT_WORKFLOW_EXPANDED_TEMPLATE_DATA_VARIABLE =
    // "WorkflowExpandedTemplateDataVariable";
    // public static final String CONCEPT_WORKFLOW_EXPANDED_TEMPLATE_ARTIFACT =
    // "WorkflowExpandedTemplateArtifact";
     ...
     * OPMW classes
     *****/
    public static final String OPMW_WORKFLOW_EXECUTION_ARTIFACT_EXPORT_DIRECT = PREFIX_EXPORT_RESOURCE
            + CONCEPT_WORKFLOW_EXECUTION_ARTIFACT;
    ...
    // public static final String OPMW_WORKFLOW_EXPANDED_TEMPLATE_PROCESS =
    // PREFIX_OPMW + CONCEPT_WORKFLOW_EXPANDED_TEMPLATE_PROCESS;
    // public static final String OPMW_WORKFLOW_EXPANDED_TEMPLATE_DATA_VARIABLE =
    // PREFIX_OPMW + CONCEPT_WORKFLOW_EXPANDED_TEMPLATE_DATA_VARIABLE;
    // public static final String OPMW_WORKFLOW_EXPANDED_TEMPLATE_PARAMETER_VARIABLE
    // = PREFIX_OPMW + CONCEPT_WORKFLOW_EXPANDED_TEMPLATE_PARAMETER_VARIABLE;
    // public static final String OPMW_WORKFLOW_EXPANDED_TEMPLATE_ARTIFACT =
    // PREFIX_OPMW+CONCEPT_WORKFLOW_EXPANDED_TEMPLATE_ARTIFACT;
    ...
    public static final String OPMW_PROP_CORRESPONDS_TO_TEMPLATE_ARTIFACT = PREFIX_OPMW
    ...
    // public static final String OPMW_PROP_BELONGS_TO_TEMPLATE =
    // PREFIX_OPMW+"belongsToTemplate";
    ...
    public static final String OPMW_PROP_IS_IMPLEMENTATION_OF_TEMPLATE_PARAMETER_VARIABLE = PREFIX_OPMW
            + "isImplementationofTemplateParameterVariable";
    ...
    public static final String OPMW_PROP_IS_DATA_BINDING_OF_EXPANDED_TEMPLATE_DATA_VARIABLE = PREFIX_OPMW
            + "isDataBindingofExpandedTemplateDataVariable";

    public static final String OPMW_PROP_IS_PARVALUE_OF_EXPANDED_TEMPLATE_PARAMETER_VARIABLE = PREFIX_OPMW
            + "isParValueofExpandedTemplateParameterVariable";
    ...
    // public static final String WINGS_PROP_HAS_TEMPLATE_DIAGRAM = WFLOW +
    // "hasTemplateDiagram";
    // public static final String WINGS_PROP_HAS_EXECUTION_DIAGRAM = WFLOW +
    // "hasExecutionDiagram";
