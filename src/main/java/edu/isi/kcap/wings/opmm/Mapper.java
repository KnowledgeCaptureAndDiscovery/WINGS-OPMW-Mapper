...
public class Mapper {
        ...
        public static ProvenanceResponseSchema main(String domain, String exportPrefix, String exportUrl,
                        ...
                        String componentLibraryFilePath, String planFilePath, String endpointQueryURI,
                        String endpointPostURI,
                        ...
                        throws IOException {
                TriplesPublisher triplesPublisher = new TriplesPublisher(endpointQueryURI, endpointPostURI, exportUrl,
                                exportPrefix, serialization);
                String catalogExportUrl = Constants.CATALOG_URI + exportPrefix;
                // Response
                ProvenanceResponseSchema response = new ProvenanceResponseSchema();
                // Create the catalog
                Catalog catalog = new Catalog(domain, catalogExportUrl,
                ...
                if (!executionExport.isExecPublished()) {
                        exportExpandedTemplate(expandedTemplateDestinationFilePath, serialization, response,
                                        executionExport);
