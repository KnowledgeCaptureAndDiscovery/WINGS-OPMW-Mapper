...
public class QueriesWorkflowTemplateExport {
    ...
    /**
     * Given a template hash, this function returns a query that will retrieve any
     * template
     * with such hash.
     * 
    ...
    // Below are the methods for queries to retrieve against a WINGS template loaded
    // in a local OntModel

    /**
     * Query for retrieving all metadata of a WINGS template.
     * The template itself does not need to be specified because there is only one
     * metadata object per template.
     * This query should be performed against an OntModel that has a single template
     * loaded.
     * 
    ...
    /**
     * Query for retrieving the elements of an abstract template from the remote
     * repository
     */
    ...
    /**
     * Given a node id, this query retrieves the variables/parameters that are used
     * as input
     * 
     * @param nodeId
     * @return
    ...
    /**
     * Given a node id, this query retrieves the variables that are produced as
     * output
     * 
     * @param nodeId
     * @return
    ...
    /**
     * String that retrieves all the "derivedFrom" relationships from a WINGS
     * template.
     * 
     ...
     * This query is used because we use ids to link templates and concrete
     * templates.
     * 
     * @param label
     * @return
