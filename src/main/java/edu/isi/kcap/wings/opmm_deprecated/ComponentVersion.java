...
import static edu.isi.kcap.wings.opmm_deprecated.Mapper.PREFIX_COMP_CATALOG;
...
/**
 * Note: this class should join all "step" into one function, or avoid
 * duplicated code.
 *
...
public class ComponentVersion {
  ...
  public static void Step1(HashSet<String> a, OntModel componentCatalog, OntModel taxonomyExport) {
    for (String inx : a) {
      ...
      String componentCatalogQueryforInteriorsofParametersComponents = Queries
          .componentCatalogQueryforInteriorsofParametersComponents(PREFIX_COMP_CATALOG, inx);
      ResultSet rnew2 = null;
      rnew2 = ModelUtils.queryLocalRepository(componentCatalogQueryforInteriorsofParametersComponents,
          componentCatalog);
  ...
  public static void Step2(HashSet<String> a, OntModel componentCatalog, OntModel taxonomyExport) {
    for (String inx : a) {
      System.out.println(inx);
      String componentCatalogQueryforInteriorsofDataComponents = Queries
          .componentCatalogQueryforInteriorsofDataComponents(PREFIX_COMP_CATALOG, inx);
      ResultSet rnew2 = null;
  ...
  public static void Step3(HashSet<String> a, OntModel componentCatalog, OntModel taxonomyExport) {
    ...
    for (String outx : a) {
      ...
      String componentCatalogQueryforInteriorsofDataComponentsOutput = Queries
          .componentCatalogQueryforInteriorsofDataComponents(PREFIX_COMP_CATALOG, outx);
      ResultSet rnew2 = null;
      rnew2 = ModelUtils.queryLocalRepository(componentCatalogQueryforInteriorsofDataComponentsOutput,
          componentCatalog);
  ...
  public static void Step4(HashSet<String> a, OntModel componentCatalog, OntModel taxonomyExport) {
    for (String inx : a) {
      System.out.println(inx);
      String componentCatalogQueryforInteriorsofParametersAbstractComponents = Queries
          .componentCatalogQueryforInteriorsofParametersComponents(PREFIX_COMP_CATALOG, inx);
      ResultSet rnew2 = null;
      rnew2 = ModelUtils.queryLocalRepository(componentCatalogQueryforInteriorsofParametersAbstractComponents,
          componentCatalog);
  ...
  public static void Step5(HashSet<String> a, OntModel componentCatalog, OntModel taxonomyExport) {
    for (String inx : a) {
      System.out.println(inx);
      String componentCatalogQueryforInteriorsofDataAbstractComponents = Queries
          .componentCatalogQueryforInteriorsofDataComponents(PREFIX_COMP_CATALOG, inx);
      ResultSet rnew2 = null;
      rnew2 = ModelUtils.queryLocalRepository(componentCatalogQueryforInteriorsofDataAbstractComponents,
          componentCatalog);
  ...
  public static void Step6(HashSet<String> a, OntModel componentCatalog, OntModel taxonomyExport) {
    for (String outx : a) {
      System.out.println(outx);
      String componentCatalogQueryforInteriorsofDataAbstractComponentsOutput = Queries
          .componentCatalogQueryforInteriorsofDataComponents(PREFIX_COMP_CATALOG, outx);
      ResultSet rnew2 = null;
      rnew2 = ModelUtils.queryLocalRepository(componentCatalogQueryforInteriorsofDataAbstractComponentsOutput,
          componentCatalog);
