...
/**
 * Classes for creating hash identifiers for templates.
 * This is needed for versioning purposes.
 * 
 * @author Daniel Garijo and Tirth Meta
 */
public class HashCreator {
    ...
    public static String getAbstractTemplateHash(String TemplateName, OntModel wingsTemplate) {
        ...
        while (r.hasNext()) {
            ...
            if (variable != null && type != null) {
                arrFinalAbstractTemplateNameRelations
                        .add("Variable " + variable.getLocalName() + " has type " + type.getLocalName());
            }
        ...
        while (r.hasNext()) {
            ...
            arrFinalAbstractTemplateNameRelations
                    .add("InputLink " + resVar.getLocalName() + " Node is " + resNode.getLocalName());
        }
        ...
        while (r.hasNext()) {
            ...
            Resource resNode = qs.getResource("?dest");
            arrFinalAbstractTemplateNameRelations
                    .add("Input-plink " + resVar.getLocalName() + " Node is " + resNode.getLocalName());
        }
        ...
        while (r.hasNext()) {
            ...
            arrFinalAbstractTemplateNameRelations
                    .add("Outputlink " + resVar.getLocalName() + " Node is " + resNode.getLocalName());
        }
        // INOUT LINKS
        ...
        while (r.hasNext()) {
            ...
            arrFinalAbstractTemplateNameRelations.add("Variable " + resVar.getLocalName() + " has origin Node "
                    + resNode.getLocalName() + " has Destination Node " + resNodeD.getLocalName());
        }
    ...
    /* This function should be merged with the previous one */
    ...
    public static String getExpandedTemplateHash(String expandedTemplateName, OntModel wingsResults) {
        ...
        while (r1names.hasNext()) {
            ...
            if (res != null && derivedFrom != null) {
                arrFinalExpandedTemplateNameRelations
                        .add(res.getLocalName() + " derivedFrom " + derivedFrom.getLocalName());
            }
        }
        ...
        while (r1names.hasNext()) {
            ...
            Resource derivedFrom = qs.getResource("?derivedFrom");
            arrFinalExpandedTemplateNameRelations
                    .add("Parameter " + res.getLocalName() + " derived From " + derivedFrom.getLocalName());
        }
        // INPUT LINKS
        ...
        while (r1names.hasNext()) {
            ...
            Resource resNode = qs.getResource("?dest");
            arrFinalExpandedTemplateNameRelations
                    .add("Variable " + resVar.getLocalName() + " has Node " + resNode.getLocalName());
        }
        // INPUT-P LINKS
        ...
        while (r1names.hasNext()) {
            ...
            Resource resNode = qs.getResource("?dest");
            arrFinalExpandedTemplateNameRelations
                    .add("Parameter " + resVar.getLocalName() + " has Node " + resNode.getLocalName());
        }
        // OUTPUT LINKS
        ...
        while (r1names.hasNext()) {
            ...
            Resource resNode = qs.getResource("?orig");
            arrFinalExpandedTemplateNameRelations
                    .add("Variable " + resVar.getLocalName() + " has origin Node " + resNode.getLocalName());
        }
        // INOUTLINKS
        ...
        while (r1names.hasNext()) {
            ...
            Resource resNode = qs.getResource("?orig");
            Resource resNodeD = qs.getResource("?dest");
            arrFinalExpandedTemplateNameRelations.add("Variable " + resVar.getLocalName() + " has origin Node "
                    + resNode.getLocalName() + " has Destination Node " + resNodeD.getLocalName());
        }
        ...
        try {
            ...
            newExpandedTemplateName = expandedTemplateName.substring(0, indexer) + "_"
                    + EncodingUtils.MD5(newExpandedTemplateName);
        } catch (Exception e) {
