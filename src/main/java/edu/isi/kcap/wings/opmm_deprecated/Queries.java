...
public class Queries {
    ...
    public static String queryNodes() {
        String query = "SELECT distinct ?n ?c ?typeComp ?isConcrete ?rule ?inport ?outport WHERE{"
                ...
                + "OPTIONAL{?cb <" + Constants.WINGS_DATA_PROP_HAS_RULE + "> ?rule }}";
        return query;
    }
    ...
    // query for determining the number of inputs and outputs in the component
    // catalog based class
    ...
    // //query for determining the number of inputs and outputs in the component
    // catalog based class
    // public static String componentCatalogQueryforInputsandOutputs11(String
    // className)
    // {
    ...
    // query for determining if the class is a subclass of a superclass in the
    // component catalog
    ...
    // query for determining the number of actual
    // inputs,outputs,isConcrete,hasLocation etc in the component catalog based
    // class
    ...
    // query for determining the number of actual
    // inputs,outputs,isConcrete,hasLocation etc FOR ABSTRACT COMPONENTS ONLY!!!! in
    // the component catalog based class
    public static String componentCatalogQueryforActualInputsandOutputsforAbstractComponent(String prefix,
            String className) {
        System.out.println("className inside the query received " + className);
    ...
    // query for determining interiors of the INPUT PARAMETERS FOR COMPONENTS
    // ONLY!!!! in the component catalog based class
    ...
    // query for determining interiors of the INPUT DATA FOR COMPONENTS ONLY!!!! in
    // the component catalog based class
     ...
     *         + "?role <"+Constants.WINGS_DATA_PROP_HAS_DIMENSIONALITY+">
     *         ?hasDim.}."
     *         + "OPTIONAL{?d a ?t ."
    ...
    /**
     * query for identifying the used relationships for parameters (slightly
     * different)
     * 
     * @return
     */
    ...
    public static String queryExecutionMetadata() {
        String query = "SELECT ?exec ?status ?startT ?endT ?user ?tool ?license WHERE{"
                ...
                // + "OPTIONAL {?fileURI <"+Constants.WINGS_DATA_PROP_HAS_EXECUTION_ENGINE+">
                // ?engine}."
                + "OPTIONAL {?exec <" + Constants.WINGS_DATA_PROP_HAS_LICENSE + "> ?license}."
                // + "OPTIONAL {?fileURI <"+Constants.WINGS_DATA_PROP_HAS_EXECUTION_DIAGRAM+">
                // ?execDiagram}."
                + "}";
        return query;
    }
    ...
    /**
     * Query that will help determine whether an execution has already been
     * published or not.
     * 
     * @param runURL
     * @return
