...
import static edu.isi.wings.opmm_deprecated.Mapper.NEW_TAXONOMY_CLASS;
import edu.isi.wings.opmm_deprecated.Queries;
...
public class ModelUtils {
    ...
    public static void addIndividualAbstractSubclass2(OntModel m, String encodepart){
        ...
        if(("Component").contains("http://")){//it is a URI
            instance2.addProperty(propSelec2,NEW_TAXONOMY_CLASS.replace("#","/")+"Component#"+"Component");            
        }else{//it is a local resource
            instance2.addProperty(propSelec2, m.getResource(NEW_TAXONOMY_CLASS.replace("#","/")+"Component#"+EncodingUtils.encode("Component")));
        }
    }
    ...
    public static void addIndividualConcreteSubclass2(OntModel m, String encodepart,String containspart){
        ...
        if((containspart).contains("http://")){//it is a URI
            instance1.addProperty(propSelec1,NEW_TAXONOMY_CLASS.replace("#","/")+"Component#"+containspart);            
        }else{//it is a local resource
            instance1.addProperty(propSelec1, m.getResource(NEW_TAXONOMY_CLASS.replace("#","/")+"Component#"+EncodingUtils.encode(containspart)));
        }
    }
    ...
    /**
     * Function to add a property between two individuals. If the property does not exist, it is created.
    ...
    public static void addProperty(OntModel m, String orig, String dest, String property){
        ...
        if(dest.contains("http://")){//it is a URI
            ...
            instance.addProperty(propSelec, m.getResource(Constants.PREFIX_EXPORT_RESOURCE+EncodingUtils.encode(dest)));
        }
