...
import edu.isi.wings.opmm_deprecated.Mapper;
import java.io.File;
...
//    @Test
    public void testTransformWINGSElaboratedTemplateToOPM_AbstractAndExpandedTemplate() {
        ...
        assertNotSame("",instance.transformWINGSElaboratedTemplateToOPMW(template, mode, outFile,taxonomy_export,"TURTLE", componentDirectory,"DomainJ1"));
...
//    @Test
    public void testtransformWINGSResultsToOPMW_AbstractAndExpandedExecution(){
        ...
        String componentDirectory = "src"+File.separator+"main"+File.separator+"resources"+File.separator+"sample_data"+File.separator+"new"+File.separator+"components"+File.separator+"";
        
        assertNotSame("",instance.transformWINGSResultsToOPMW(execution, lib, mode, outFileOPMW, outFilePROV,null, data_catalog, "TURTLE",data_URI,"DomainJ1",taxonomy_export,componentDirectory));
...
//        File f2 = new File(outFilePROV);
   ...
   // @Test
    public void validateExportSimpleTemplate(){
        //the other tests validate the generation. This test validates the semantics of the exported contents.
        ...
        instance.transformWINGSElaboratedTemplateToOPMW(template, mode, outFile,taxonomy_export,"TURTLE", componentDirectory,"DomainJ1");
...
//        String data_catalog="TestingDomain1"+File.separator+"Data"+File.separator+"TestingDomain_DataCatalog.owl";
//        String data_URI="src"+File.separator+"main"+File.separator+"resources"+File.separator+"sample_data"+File.separator+"new"+File.separator+"simple_abstract"+File.separator+"data"+File.separator;
//        instance2.transformWINGSResultsToOPMW(execution, lib, mode, outFileOPMW, outFilePROV,null, data_catalog, "TURTLE",data_URI,"DomainJ1", taxonomy_export);
//        
...
//        validateModel(m1);
   ...
   // @Test
    public void validateExportComplexTemplate(){
        //the other tests validate the generation. This test validates the semantics of the exported contents.
        System.out.println("Validating template and execution");
        String mode = "RDF/XML";
        ...
        instance.transformWINGSElaboratedTemplateToOPMW(template, mode, outFile,taxonomy_export,"TURTLE", componentDirectory,"DomainAquaflow_NTM");
        ...
        String data_catalog="TestingDomain1"+File.separator+"Data"+File.separator+"TestingDomain_DataCatalog.owl";
        String data_URI="src"+File.separator+"main"+File.separator+"resources"+File.separator+"sample_data"+File.separator+"new"+File.separator+"aquaflow_ntm"+File.separator+"data"+File.separator;
        instance2.transformWINGSResultsToOPMW(execution, lib, mode, outFileOPMW, outFilePROV,null, data_catalog, "TURTLE",data_URI,"DomainAquaflow_NTM", taxonomy_export,componentDirectory);
    ...
    /**
     * Function to validate an OPMW Model. It includes a set of tests for both executions and templates
     * @param m 
     */
    public void validateModel(OntModel m){
        ...
        problems = Integer.parseInt(Utils.getCountOf(Queries.COUNT_ARTIFACTS_WITHOUT_BINDING_TO_PROCESS, m, "countArt"));
        assertTrue(problems <= 0);
        //execution processes
        ...
        problems = Integer.parseInt(Utils.getCountOf(Queries.COUNT_PROCESSES_NOT_BOUND_TO_ARTIFACT, m, "countProc"));
        assertTrue(problems <= 0);
        System.out.println("Validating: ALL EXECUTION PROCESSES SHOULD HAVE AN EXECUTION CODE ASSOCIATED TO THEM.");
        problems = Integer.parseInt(Utils.getCountOf(Queries.COUNT_PROCESSES_WITHOUT_CODE, m, "countProc"));
        assertTrue(problems <= 0);
        System.out.println("Validating: ALL EXECUTION PROCESSES SHOULD CORRESPOND TO A TEMPLATE PROCESS THAT BELONGS TO A TEMPLATE.");
        problems = Integer.parseInt(Utils.getCountOf(Queries.COUNT_PROCESSES_WITHOUT_CORRECT_TEMPLATE_BINDING, m, "countProc"));
        assertTrue(problems <= 0);
        //execution accounts
        ...
        problems = Integer.parseInt(Utils.getCountOf(Queries.COUNT_EXECUTIONS_WITHOUT_TIME_OR_STATUS, m, "countAcc"));
        assertTrue(problems <= 0);
        //template artifacts
        System.out.println("Validating:  ALL TEMPLATE ARTIFCATS MUST BELONG TO A TEMPLATE.");
        problems = Integer.parseInt(Utils.getCountOf(Queries.COUNT_TEMPL_ARTIFACTS_WITHOUT_TEMPLATE, m, "countArt"));
        assertTrue(problems <= 0);
        System.out.println("Validating:  ALL TEMPLATE ARTIFACTS MUST BE CONNECTED TO A TEMPLATE PROCESS (testing in  OPMW).");
        problems = Integer.parseInt(Utils.getCountOf(Queries.COUNT_TEMPL_ARTIFACTS_WITHOUT_PROCESS_OPMW, m, "countArt"));
        assertTrue(problems <= 0);
        System.out.println("Validating:  ALL TEMPLATE ARTIFACTS MUST BE CONNECTED TO A TEMPLATE PROCESS (testing in P-PLAN).");
        problems =Integer.parseInt(Utils.getCountOf(Queries.COUNT_TEMPL_ARTIFACTS_WITHOUT_PROCESS_P_PLAN, m, "countArt"));
        assertTrue(problems <= 0);
        //template processes
        ...
        problems = Integer.parseInt(Utils.getCountOf(Queries.COUNT_TEMPL_PROCESSES_WITHOUT_TEMPLATE_OPMW, m, "countProc"));
        assertTrue(problems <= 0);
        System.out.println("Validating: ALL TEMPLATE PROCESSES MUST BELONG TO A TEMPLATE (test in PPlan).");
        problems = Integer.parseInt(Utils.getCountOf(Queries.COUNT_TEMPL_PROCESSES_WITHOUT_TEMPLATE_PPLAN, m, "countProc"));
        assertTrue(problems <= 0);
        ...
        assertTrue(problems <= 0);
        System.out.println("Validating:  ALL TEMPLATE PROCESSES MUST USE OR GENERATE A TEMPLATE ARTIFACT (test in OPMW).");
        problems = Integer.parseInt(Utils.getCountOf(Queries.COUNT_TEMPL_PROCESS_WITHOUT_BINDING_TO_ARTIFACT_OPMW, m, "countProc"));
        assertTrue(problems <= 0);
        System.out.println("Validating:  ALL TEMPLATE PROCESSES MUST USE OR GENERATE A TEMPLATE ARTIFACT (test in P-PLAN).");
        problems = Integer.parseInt(Utils.getCountOf(Queries.COUNT_TEMPL_PROCESS_WITHOUT_BINDING_TO_ARTIFACT_PPLAN, m, "countProc"));
        assertTrue(problems <= 0);
        
        //expanded template (TO DO)
        System.out.println("Validating:  ALL EXPANDED TEMPLATE PROCESSES SHOULD LINK TO A TEMPLATE.");
        //TO DO
        System.out.println("Validating:  ALL EXPANDED TEMPLATE PROCESSES SHOULD BE IMPLEMENTATIONS OF A TEMPLATE PROCESS.");
        //TO DO
        System.out.println("Validating:  ALL EXPANDED TEMPLATE SHOULD LINK TO A TEMPLATE.");
        //TO DO
        System.out.println("Validating:  ALL EXPANDED TEMPLATE VARIABLES SHOULD LINK TO A TEMPLATE VARIABLE THAT BELONG TO A TEMPLATE (AND AND EXECUTION).");
        //TO DO
        System.out.println("Validating:  ALL EXPANDED PARAMETER VARIABLES SHOULD LINK TO A PARAMETER VARIABLE THAT BELONG TO A TEMPLATE (AND AND EXECUTION).");
        //TO DO
        //the following won't work at the moment
        System.out.println("Validating:  ALL W3ID COMPONENT CLASSES SHOULD HAVE A LABEL (OTHERWISE THEY ARE NOT CORRECTLY LINKED).");
        //TO DO
        //the following won't work at the moment
        System.out.println("Validating:  ALL W3ID DATA CLASSES SHOULD HAVE A LABEL (OTHERWISE THEY ARE NOT CORRECTLY LINKED).");
        //TO DO
