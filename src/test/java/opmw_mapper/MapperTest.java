...
public class MapperTest {
    ...
    public void testTransformWINGSElaboratedTemplateToOPM_AbstractAndExpandedTemplate() {
        ...
        String template = "src" + File.separator + "main" + File.separator + "resources" + File.separator
                + "sample_data" + File.separator + "new" + File.separator + "simple_abstract" + File.separator
                + "template.owl";
        ...
        assertNotSame("", instance.transformWINGSElaboratedTemplateToOPMW(template, mode, outFile, taxonomy_export,
    ...
    public void testtransformWINGSResultsToOPMW_AbstractAndExpandedExecution() {
        ...
        String lib = "src" + File.separator + "main" + File.separator + "resources" + File.separator + "sample_data"
                + File.separator + "new" + File.separator + "simple_abstract" + File.separator + "library.owl";
        ...
        String data_URI = "src" + File.separator + "main" + File.separator + "resources" + File.separator
                + "sample_data" + File.separator + "new" + File.separator + "simple_abstract" + File.separator + "data"
                + File.separator;
        String componentDirectory = "src" + File.separator + "main" + File.separator + "resources" + File.separator
                + "sample_data" + File.separator + "new" + File.separator + "components" + File.separator + "";
    ...
    public void validateExportComplexTemplate() {
        ...
        Mapper instance = new Mapper();
        String template = "src" + File.separator + "main" + File.separator + "resources" + File.separator
                + "sample_data" + File.separator + "new" + File.separator + "aquaflow_ntm" + File.separator
                + "template.owl";
        String taxonomy_export = "TestingDomain1" + File.separator + "Component" + File.separator
                + "TestingDomain_TaxonomyHierarchyModel.owl";
        String componentDirectory = "src" + File.separator + "main" + File.separator + "resources" + File.separator
        ...
        String lib = "src" + File.separator + "main" + File.separator + "resources" + File.separator + "sample_data"
                + File.separator + "new" + File.separator + "aquaflow_ntm" + File.separator + "library.owl";
        String execution = "src" + File.separator + "main" + File.separator + "resources" + File.separator
                + "sample_data" + File.separator + "new" + File.separator + "aquaflow_ntm" + File.separator
                + "execution.owl";
        String data_catalog = "TestingDomain1" + File.separator + "Data" + File.separator
                + "TestingDomain_DataCatalog.owl";
        String data_URI = "src" + File.separator + "main" + File.separator + "resources" + File.separator
                + "sample_data" + File.separator + "new" + File.separator + "aquaflow_ntm" + File.separator + "data"
                + File.separator;
        instance2.transformWINGSResultsToOPMW(execution, lib, mode, outFileOPMW, outFilePROV, null, data_catalog,
    ...
    public void validateModel(OntModel m) {
        ...
        problems = Integer.parseInt(
                Utils.getCountOf(Queries.COUNT_ARTIFACTS_WITHOUT_BINDING_TO_TEMPLATE_ARTIFACT, m, "countArt"));
        assertTrue(problems <= 0);
        System.out.println("Validating: ALL EXECUTION ARTIFACTS SHOULD BE USED OR GENERATED BY A PROCESS.");
        problems = Integer
                .parseInt(Utils.getCountOf(Queries.COUNT_ARTIFACTS_WITHOUT_BINDING_TO_PROCESS, m, "countArt"));
        assertTrue(problems <= 0);
        // execution processes
        ...
        problems = Integer
                .parseInt(Utils.getCountOf(Queries.COUNT_PROCESSES_WITHOUT_CORRECT_TEMPLATE_BINDING, m, "countProc"));
        assertTrue(problems <= 0);
        // execution accounts
        ...
        problems = Integer
                .parseInt(Utils.getCountOf(Queries.COUNT_TEMPL_ARTIFACTS_WITHOUT_PROCESS_OPMW, m, "countArt"));
        assertTrue(problems <= 0);
        System.out.println(
                "Validating:  ALL TEMPLATE ARTIFACTS MUST BE CONNECTED TO A TEMPLATE PROCESS (testing in P-PLAN).");
        problems = Integer
                .parseInt(Utils.getCountOf(Queries.COUNT_TEMPL_ARTIFACTS_WITHOUT_PROCESS_P_PLAN, m, "countArt"));
        assertTrue(problems <= 0);
        // template processes
        System.out.println(
                "Validating: ALL TEMPLATE PROCESSES MUST USE OR GENERATE A TEMPLATE ARTIFACT (test in P-PLAN).");
        problems = Integer.parseInt(
                Utils.getCountOf(Queries.COUNT_TEMPL_PROCESS_WITHOUT_BINDING_TO_ARTIFACT_OPMW, m, "countProc"));
        assertTrue(problems <= 0);
        System.out.println("Validating: ALL TEMPLATE PROCESSES MUST BELONG TO A TEMPLATE (test in OPMW).");
        problems = Integer
                .parseInt(Utils.getCountOf(Queries.COUNT_TEMPL_PROCESSES_WITHOUT_TEMPLATE_OPMW, m, "countProc"));
        assertTrue(problems <= 0);
        System.out.println("Validating: ALL TEMPLATE PROCESSES MUST BELONG TO A TEMPLATE (test in PPlan).");
        problems = Integer
                .parseInt(Utils.getCountOf(Queries.COUNT_TEMPL_PROCESSES_WITHOUT_TEMPLATE_PPLAN, m, "countProc"));
        assertTrue(problems <= 0);
        ...
        System.out.println(
                "Validating:  ALL TEMPLATE PROCESSES MUST USE OR GENERATE A TEMPLATE ARTIFACT (test in P-PLAN).");
        problems = Integer.parseInt(
                Utils.getCountOf(Queries.COUNT_TEMPL_PROCESS_WITHOUT_BINDING_TO_ARTIFACT_PPLAN, m, "countProc"));
        assertTrue(problems <= 0);
