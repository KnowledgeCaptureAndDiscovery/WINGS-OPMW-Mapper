...
public class MapperTestNew {
    ...
    public void testMapperTurtle() throws IOException {
        ...
        TriplesPublisher catalogTriplesPublisher = new TriplesPublisher(endpointQueryURI, endpointPostURI,
            ...
            assertTrue(response.getWorkflowExpandedTemplate().getFilePath().contains("tmp/TTL/expandedTemplate.ttl"));
            assertTrue(response.getWorkflowExpandedTemplate().getFileUrl().contains(executionTriplesPublisher.exportUrl));
            assertTrue(response.getWorkflowExpandedTemplate().getGraphUrl().contains(executionTriplesPublisher.exportUrl));
            assertTrue(response.getWorkflowAbstractTemplate().getFilePath().contains("tmp/TTL/abstractTemplate.ttl"));
            assertTrue(response.getWorkflowAbstractTemplate().getFileUrl().contains(executionTriplesPublisher.exportUrl));
            assertTrue(response.getWorkflowAbstractTemplate().getGraphUrl().contains(executionTriplesPublisher.exportUrl));
